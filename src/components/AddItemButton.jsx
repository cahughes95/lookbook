export default function AddItemButton({ onClick }) {
  return (
    <button
      onClick={onClick}
      className="fixed bottom-24 right-6 w-14 h-14 bg-white rounded-full flex items-center justify-center z-50 active:scale-90 transition-transform duration-100"
